...
public class WorkflowMapper {
    ...
    public WorkflowDtos.BorrowRequestResponse toBorrowRequestResponse(BorrowRequest request) {
        return new WorkflowDtos.BorrowRequestResponse(
            ...
            request.getAsset() == null ? null : MapperUtils.uuid(request.getAsset().getId()),
            request.getAsset() == null ? null : request.getAsset().getCode(),
            request.getAsset() == null ? null : request.getAsset().getName(),
            MapperUtils.uuid(request.getCategory().getId()),
